...
$is_admin = $_SESSION['role'] == 1; // 是否是管理员
?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    <title>捷顺ims - 首页</title>
...
<body>
    <div class="layout-container">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <!-- <div class="logo"><a href="index.php">捷顺ims</a></div> -->
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (isCollapsed) {
                    ...
                    // 展开状态下的图标
                    svg.innerHTML = '<path d="M111.936 896a48 48 0 1 1 0-96h800a48 48 0 1 1 0 96z m230.4-199.616l-224-143.872a47.936 47.936 0 0 1 0-80.896l224-143.872a46.72 46.72 0 0 1 25.6-7.616 48.704 48.704 0 0 1 22.976 5.824 48.064 48.064 0 0 1 25.024 42.112v288a47.872 47.872 0 0 1-25.024 42.048 48.512 48.512 0 0 1-23.104 5.888 46.464 46.464 0 0 1-25.6-7.68zM232.96 512.128l87.104 56V456z m295.104 143.936a48 48 0 0 1 0-96h352a48 48 0 0 1 0 96z m0-192a48 48 0 0 1 0-96h352a48 48 0 0 1 0 96z m-416-240a48 48 0 1 1 0-96h800a48 48 0 0 1 0 96z" fill="#585858" p-id="1758"></path>';
        ...
        <div class="content">
            ...
            <div class="card">
                ...
                <p style="margin-top: 10px; color: #666; line-height: 1.8;">
                    捷顺ims是一个专业的商品库存管理系统，支持商品信息的完整生命周期管理，包括商品的添加、编辑、删除，以及商品的入库和出库操作。
                </p>
                <p style="margin-top: 10px; color: #666; line-height: 1.8;">
                    <strong>普通用户功能：</strong>商品管理、商品入库、入库记录查询、商品出库、出库记录查询。支持按商品名称、操作人、日期、采购单位/领取单位等条件进行搜索。
                </p>
                <p style="margin-top: 10px; color: #666; line-height: 1.8;">
                    <strong>管理员专属功能：</strong>用户管理（添加/编辑/删除用户、设置昵称、分配角色）、系统日志查看、数据备份。管理员拥有系统全部权限。
                </p>
            </div>
        </div>
    </div>
